# 2018-12-21 ToF CV Controller v00 Trellis.py
# simple demo of the VL53L0X distance sensor
# with the 4-digit alphanumeric LED wing
...
# ### Main ###
print("2018-12-21 ToF CV Controller v00 Trellis.py")
...
while True:
    range = vl53.range
    if range <= 500:
        x,y = plot(int(map_range(range, 0, 500, 0, 32)))
        display.print(range)
        display.show()
        trellis.pixels[x, y] = 0x323200
        pitch_dac.value = int(65520 * range / 500)
        old_range = range
