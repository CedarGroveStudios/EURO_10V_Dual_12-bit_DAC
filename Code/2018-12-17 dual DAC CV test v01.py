# 2018-12-17 dual DAC CV test v01.py
...
# dac2 = adafruit_mcp4725.MCP4725(dac_i2c, address=0x62)
# dac3 = adafruit_mcp4725.MCP4725(dac_i2c, address=0x63)
...
print("2018-12-17 dual DAC CV test v01.py")

while True:

    x, y, z = accelerometer.acceleration
    # print((x,y,z))
    new_y = map_range(x, -10, 10, 0, 1.0)
    new_x = map_range(y, 10, -10, 0, 1.0)
    new_z = map_range(z, -15, -20, 100, 65535)
    ...
    # print(new_x, new_y)
    # dac2.normalized_value = new_x
    # dac3.normalized_value = new_y
